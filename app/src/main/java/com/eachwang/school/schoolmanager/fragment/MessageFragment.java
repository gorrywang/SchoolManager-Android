...
import static com.eachwang.school.schoolmanager.http.HttpUtils.GET_NOTICE_URL;
...
public class MessageFragment extends Fragment {
    @BindView(R.id.frag_message_recycler_load)
    RecyclerView mRecycler;
    Unbinder unbinder;
    @BindView(R.id.frag_message_swipe_refresh)
    SwipeRefreshLayout mRefresh;
    private View mView;
    private List<MessageBean> mList = new ArrayList<>();
    private int[] mColorList = new int[]{R.color.colorPrimary, R.color.s1, R.color.s2, R.color.s3, R.color.s4, R.color.s5, R.color.s6};
    ...
    private void getData() {
        HttpUtils.getJsonByPostBack(GET_NOTICE_URL, new RequestParams(), new TextHttpResponseHandler() {
            @Override
     ...
     * 适配器
     */
    private class MyAdapter extends BaseQuickAdapter<MessageBean, MyAdapter.ViewHolder> {


        public MyAdapter(int layoutResId, List<MessageBean> data) {
